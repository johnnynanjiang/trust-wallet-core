...
TEST(HDWallet, Derive) {
    auto wallet = WRAP(TWHDWallet, TWHDWalletCreateWithMnemonic(words.get(), passphrase.get()));
    auto key0 = WRAP(TWPrivateKey, TWHDWalletGetKey(wallet.get(), BIP44, COIN_ETHEREUM, 0, 0, 0));
    auto key1 = WRAP(TWPrivateKey, TWHDWalletGetKey(wallet.get(), BIP44, COIN_ETHEREUM, 0, 0, 1));
...
TEST(HDWallet, DeriveBitcoin) {
    auto wallet = WRAP(TWHDWallet, TWHDWalletCreateWithMnemonic(words.get(), passphrase.get()));
    auto key = WRAP(TWPrivateKey, TWHDWalletGetKey(wallet.get(), BIP84, COIN_BITCOIN, 0, 0, 0));
...
TEST(HDWallet, ExtendedKeys) {
    ...
    auto xprv = WRAPS(TWHDWalletGetExtendedPrivateKey(wallet.get(), BIP44, COIN_BITCOIN, HD_XPRV));
    auto xpub = WRAPS(TWHDWalletGetExtendedPublicKey(wallet.get(), BIP44, COIN_BITCOIN, HD_XPUB));
    ...
    auto yprv = WRAPS(TWHDWalletGetExtendedPrivateKey(wallet.get(), BIP49, COIN_BITCOIN, HD_YPRV));
    auto ypub = WRAPS(TWHDWalletGetExtendedPublicKey(wallet.get(), BIP49, COIN_BITCOIN, HD_YPUB));
    ...
    auto zprv = WRAPS(TWHDWalletGetExtendedPrivateKey(wallet.get(), BIP84, COIN_BITCOIN, HD_ZPRV));
    auto zpub = WRAPS(TWHDWalletGetExtendedPublicKey(wallet.get(), BIP84, COIN_BITCOIN, HD_ZPUB));
...
TEST(HDWallet, PublicKeyFromX) {
    ...
    auto xpubAddr2 = TWHDWalletGetPublicKeyFromExtended(xpub.get(), HD_XPUB, HD_XPRV, 0, 2);
    auto xpubAddr9 = TWHDWalletGetPublicKeyFromExtended(xpub.get(), HD_XPUB, HD_XPRV, 0, 9);
...
TEST(HDWallet, PublicKeyFromY) {
    ...
    auto ypubAddr3 = TWHDWalletGetPublicKeyFromExtended(ypub.get(), HD_YPUB, HD_YPRV, 0, 3);
    auto ypubAddr10 = TWHDWalletGetPublicKeyFromExtended(ypub.get(), HD_YPUB, HD_YPRV, 0, 10);
...
TEST(HDWallet, PublicKeyFromZ) {
    ...
    auto zpubAddr4 = TWHDWalletGetPublicKeyFromExtended(zpub.get(), HD_ZPUB, HD_ZPRV, 0, 4);
    auto zpubAddr11 = TWHDWalletGetPublicKeyFromExtended(zpub.get(), HD_ZPUB, HD_ZPRV, 0, 11);
