...
TEST(BitcoinTransaction, Encode) {
    ...
    auto script0 = WRAP(TWBitcoinScript, TWBitcoinScriptCreate(DATA("").get()));
    ...
    auto script1 = WRAP(TWBitcoinScript, TWBitcoinScriptCreate(DATA("").get()));
    ...
    auto script2 = WRAP(TWBitcoinScript, TWBitcoinScriptCreate(DATA("").get()));
    TWBitcoinTransactionAddInput(transaction.get(), po2, script2.get(), 4294967295);

    auto oscript0 = WRAP(TWBitcoinScript, TWBitcoinScriptCreate(DATA("76a9141fc11f39be1729bf973a7ab6a615ca4729d6457488ac").get()));
    TWBitcoinTransactionAddOutput(transaction.get(), 18000000, oscript0.get());

    auto oscript1 = WRAP(TWBitcoinScript, TWBitcoinScriptCreate(DATA("0x76a914f2d4db28cad6502226ee484ae24505c2885cb12d88ac").get()));
