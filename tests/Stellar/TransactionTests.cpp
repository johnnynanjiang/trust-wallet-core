...
const char * NETWORK_PASSPHRASE_PUBLIC = "Public Global Stellar Network ; September 2015";
...
TEST(Stellar, SignTransaction) {
    ...
    TW::Data hashHash = TW::Hash::sha256(hash);
    std::string hashHexStr = TW::hex(hash.begin(), hash.end());
    std::string hashHashHexStr = TW::hex(hashHash.begin(), hashHash.end());
    EXPECT_EQ("cee0302d59844d32bdca915c8203dd44b33fbb7edc19051ea37abedf28ecd472", hashHexStr);
    EXPECT_EQ("f016a53457a4476cf07e542bd23736b4f19aae21a91dfa14841b648522bdc2da", hashHashHexStr);
}